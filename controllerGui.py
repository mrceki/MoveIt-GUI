...
# Form implementation generated from reading ui file 'pose_joint_goal2.ui'
#
...
"}")
        ...
        def thread_pose(): 
            t2= Thread(target=self.pose)
            t2.start()

        def thread_joint(): 
            t4= Thread(target=self.joint)
            t4.start()

        self.poseGoButton.clicked.connect(thread_pose)
        self.jointGoButton.clicked.connect(thread_joint)
    ...
    def servoj_init(self):
        ...
        self.moveit2_servoj = MoveIt2ServoJoints(
            ...
            joint_names=sr80.joint_names(),  #["shoulder_pan_joint","shoulder_lift_joint","elbow_joint","wrist_1_joint","wrist_2_joint","wrist_3_joint"],
            callback_group=callback_group,
        )
